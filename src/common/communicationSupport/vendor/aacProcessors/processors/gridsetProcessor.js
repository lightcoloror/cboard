...
class GridsetProcessor extends BaseProcessor {
  ...
  _extractWordsFromWordList(param) {
    ...
    const items =
      wordList.Items?.WordListItem || wordList.items?.wordlistitem || [];
  ...
  async loadIntoTree(filePathOrBuffer) {
    ...
    for (const entry of entries) {
      ...
      if (isGridXmlEntry(entry.entryName)) {
        ...
        try {
          ...
          console.log(
            `[Gridset] Raw XML content (first 200 chars) for ${
              entry.entryName
            }:`,
        ...
        if (cells) {
              ...
              if (text) {
                ...
                if (val) {
                  ...
                  if (pageWordListItems.length < 3) {
                    console.log(
                      `[WordList] Extracted text: "${val}" (length: ${
                        val.length
                      }, has spaces: ${val.includes(' ')})`
                    );
                    console.log(
                      `[WordList] Chars:`,
                      Array.from(val)
          ...
          allCellsToProcess.forEach(({ cell, idx }) => {
            ...
            if (declaredImageName && resolvedImageEntry) {
              console.log(
                `[GridsetProcessor] Cell (${cellX + 1},${cellY +
                  1}) [XML coords]: ${declaredImageName} -> ${resolvedImageEntry}`
              );
            } else if (declaredImageName && !resolvedImageEntry) {
              console.log(
                `[GridsetProcessor] Cell (${cellX + 1},${cellY +
                  1}) [XML coords]: ${declaredImageName} -> NOT FOUND`
              );
            }
            ...
            if (commands) {
              ...
              for (const command of commandArr) {
                ...
                const getParam = key => {
                  ...
                  const simpleValue =
                    param['#text'] ?? param.text ?? param.value;
                  ...
                  case 'Jump.Favorite':
                    if (!semanticAction) {
                      ...
                      semanticAction = {
                        ...
                        platformData: {
                          grid3: { commandId, parameters: params }
                        },
                        fallback: {
                          type: 'ACTION',
                          message:
                  ...
                  case 'Action.Punctuation': {
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        text: ch,
                        platformData: {
                          grid3: { commandId, parameters: { letter: ch } }
                        },
                  ...
                  case 'Speech.ChangePublicVolume':
                    if (!semanticAction) {
                      ...
                      semanticAction = {
                        ...
                        intent: AACSemanticIntent.PLATFORM_SPECIFIC,
                        platformData: {
                          grid3: { commandId, parameters: speechParams }
                        },
                        fallback: {
                          type: 'ACTION',
                  ...
                  case 'ComputerControl.Keyboard': {
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        text: keystring,
                        platformData: {
                          grid3: { commandId, parameters: { keystring } }
                        },
                        fallback: {
                          type: 'ACTION',
                  ...
                  case 'ComputerControl.SendKeys': {
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        text: keys,
                        platformData: {
                          grid3: { commandId, parameters: { keys } }
                        },
                        fallback: {
                          type: 'ACTION',
                  ...
                  case 'Mouse.Move': {
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        platformData: {
                          grid3: { commandId, parameters: { x: mx, y: my } }
                        },
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        platformData: {
                          grid3: {
                            commandId,
                            parameters: { action: getParam('action') }
                          }
                        },
                  ...
                  case 'WebBrowser.NavigateUrl': {
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        text: url,
                        platformData: {
                          grid3: { commandId, parameters: { url } }
                        },
                        fallback: {
                          type: 'ACTION',
                  ...
                  case 'WebBrowser.ScrollRight': {
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        platformData: {
                          grid3: { commandId, parameters: { size: scrollSize } }
                        },
                        fallback: {
                          type: 'ACTION',
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        platformData: {
                          grid3: {
                            commandId,
                            parameters: { action: toggleAction }
                          }
                        },
                        fallback: {
                          type: 'ACTION',
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        platformData: {
                          grid3: {
                            commandId,
                            parameters: { commandid: jsCommandId }
                          }
                        },
                        fallback: {
                          type: 'ACTION',
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        platformData: {
                          grid3: {
                            commandId,
                            parameters: { commandid: speakCmdId }
                          }
                        },
                        fallback: {
                          type: 'ACTION',
                  ...
                  case 'WebBrowser.MoreLinks': {
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        parameters: { webAction: commandId },
                        platformData: {
                          grid3: { commandId, parameters: favParams }
                        },
                        fallback: {
                          type: 'ACTION',
                          message: commandId.replace('WebBrowser.', '')
                  ...
                  case 'MusicVideo.StoreAsAttachmentCommandId': {
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        parameters: mvParams,
                        platformData: {
                          grid3: { commandId, parameters: mvParams }
                        },
                        fallback: {
                          type: 'ACTION',
                  ...
                  case 'Settings.RequiredFeature': {
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        intent: AACSemanticIntent.PLATFORM_SPECIFIC,
                        platformData: {
                          grid3: { commandId, parameters: { feature } }
                        },
                        fallback: {
                          type: 'ACTION',
                  ...
                  case 'Prediction.MoreWords': {
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        intent: AACSemanticIntent.PLATFORM_SPECIFIC,
                        platformData: {
                          grid3: { commandId, parameters: predParams }
                        },
                        fallback: {
                          type: 'ACTION',
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        platformData: {
                          grid3: {
                            commandId,
                            parameters: { context: getParam('context') }
                          }
                        },
                  ...
                  case 'Email.AttachFile': {
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        intent: AACSemanticIntent.PLATFORM_SPECIFIC,
                        platformData: {
                          grid3: { commandId, parameters: emailParams }
                        },
                        fallback: {
                          type: 'ACTION',
                  ...
                  case 'Sms.AddRecipient': {
                    ...
                    if (!semanticAction) {
                      semanticAction = {
                        ...
                        intent: AACSemanticIntent.PLATFORM_SPECIFIC,
                        platformData: {
                          grid3: { commandId, parameters: smsParams }
                        },
                        fallback: {
                          type: 'ACTION',
            ...
            const button = new AACButton({
              ...
              parameters: {
                ...
                ...(imageData
                  ? { imageData, image_id: resolvedImageEntry }
                  : {})
              }
            });
    ...
    try {
      ...
      if (settingsEntry) {
        ...
        const picSearchKeys =
          settingsData?.GridSetSettings?.PictureSearch?.PictureSearchKeys
            ?.PictureSearchKey ||
          settingsData?.gridSetSettings?.pictureSearch?.pictureSearchKeys
            ?.pictureSearchKey ||
          settingsData?.GridsetSettings?.PictureSearch?.PictureSearchKeys
    ...
    if (metadata.defaultKeyboardPageId) {
      Object.values(tree.pages).forEach(page => {
        page.buttons.forEach(button => {
          if (
            button?.semanticAction?.platformData?.grid3?.commandId ===
              'Jump.ToKeyboard' &&
            !button.targetPageId
          ) {
  ...
  async saveFromTree(tree, outputPath) {
    ...
    const settingsData = {
      ...
      GridSetSettings: {
        ...
        DocumentationUrl:
          tree.metadata?.homepageUrl || tree.metadata?.url || '',
      ...
      FileMap: {
        ...
        Entries: {
          Entry: gridFilePaths.map(gridPath => {
            ...
            const gridName =
              gridPath.match(/Grids\/([^/]+)\/grid\.xml$/)?.[1] || '';
            const imageFiles = [];

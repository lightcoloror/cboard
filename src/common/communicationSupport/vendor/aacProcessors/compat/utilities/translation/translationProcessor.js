...
export function normalizeButtonForTranslation(
  ...
  return {
    ...
    label,
    message,
    textToTranslate: message || label,
    // Translate message if present, otherwise label
    symbols,
    grammar,
    ...context
  };
...
export function extractSymbolsFromButton(button) {
  ...
  if (
    ...
    (_button$semanticActio = _button$semanticActio.richText) !== null &&
    _button$semanticActio !== void 0 &&
    _button$semanticActio.symbols
  ) {
  ...
  for (const button of buttons) {
    ...
    const grammar =
      ...
      _button$parameters === void 0
        ? void 0
        : _button$parameters.grammar) || undefined;
    results.push(
...
export function validateTranslationResults(
  ...
  if (
    originalButtonIds &&
    !(options !== null && options !== void 0 && options.allowPartial)
  ) {

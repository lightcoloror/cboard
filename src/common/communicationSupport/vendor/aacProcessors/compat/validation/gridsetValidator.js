...
export class GridsetValidator extends BaseValidator {
  ...
  async validateZipArchive(content, filename, _filesize) {
    ...
    await this.add_check(
      'gridset_xml_presence',
      'gridset.xml presence',
      async () => {
        const gridsetEntry = entries.find(
          e => e.toLowerCase() === 'gridset.xml'
        );
        if (!gridsetEntry) {
    ...
    await this.add_check(
      'settings_xml_presence',
      'settings.xml presence',
      async () => {
        const settingsEntry = entries.find(
          e => e.toLowerCase() === 'settings.xml'
        );
        if (!settingsEntry) {
          this.warn(
            'Missing settings.xml in archive (required for full metadata)'
          );
        } else {
          try {
  ...
  async validateGridsetStructure(gridset, _filename, _content) {
    var _gridset$pages, _gridset$Pages;
    ...
    await this.add_check('gridset_name', 'gridset name', async () => {
      ...
      const name =
        gridset.$.name ||
        gridset.$.Name ||
        ((_gridset$name = gridset.name) === null || _gridset$name === void 0
          ? void 0
          : _gridset$name[0]);
      if (!name) {
    ...
    const pages =
      ((_gridset$pages = gridset.pages) === null || _gridset$pages === void 0
        ? void 0
        : _gridset$pages[0]) ||
      ((_gridset$Pages = gridset.Pages) === null || _gridset$Pages === void 0
        ? void 0
  ...
  async validatePage(page, index) {
    ...
    await this.add_check(
      ...
      async () => {
        ...
        const name =
          page.$.name ||
          page.$.Name ||
          ((_page$name = page.name) === null || _page$name === void 0
            ? void 0
            : _page$name[0]);
        if (!name) {
    ...
    await this.add_check(
      ...
      async () => {
        ...
        if (!cells) {
          ...
          var _cells$, _cells$2;
          const cellArray =
            ((_cells$ = cells[0]) === null || _cells$ === void 0
              ? void 0
              : _cells$.cell) ||
            ((_cells$2 = cells[0]) === null || _cells$2 === void 0
              ? void 0
              : _cells$2.Cell);
          if (
            !cellArray ||
    ...
    const cells =
      ((_page$cells = page.cells) === null || _page$cells === void 0
        ? void 0
        : _page$cells[0]) ||
      ((_page$Cells = page.Cells) === null || _page$Cells === void 0
        ? void 0

...
export class BaseValidator {
  constructor(options = {}) {
    var _options$includeWarni, _options$stopOnBlocke;
    this._errors = 0;
    this._warnings = 0;
    this._checks = [];
    this._sub_checks = [];
    ...
    this._options = {
      includeWarnings:
        (_options$includeWarni = options.includeWarnings) !== null &&
        _options$includeWarni !== void 0
          ? _options$includeWarni
          : true,
      stopOnBlocker:
        (_options$stopOnBlocke = options.stopOnBlocker) !== null &&
        _options$stopOnBlocke !== void 0
          ? _options$stopOnBlocke
          : true,

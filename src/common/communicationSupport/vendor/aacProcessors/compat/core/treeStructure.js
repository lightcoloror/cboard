  ...
  traverse(callback) {
    ...
    while (queue.length > 0) {
      ...
      if (page) {
        ...
        page.buttons
          .filter(b => {
            var _b$semanticAction, _b$semanticAction2;
            const i = String(
              (_b$semanticAction = b.semanticAction) === null ||
                _b$semanticAction === void 0
                ? void 0
                : _b$semanticAction.intent
            );
            return (
              i === 'NAVIGATE_TO' ||
              !!(
                (_b$semanticAction2 = b.semanticAction) !== null &&
                _b$semanticAction2 !== void 0 &&
                _b$semanticAction2.targetId
              ) ||
              !!b.targetPageId
            );
          })
          .forEach(b => {
            var _b$semanticAction3;
            const target =
              ((_b$semanticAction3 = b.semanticAction) === null ||
              _b$semanticAction3 === void 0
                ? void 0
                : _b$semanticAction3.targetId) || b.targetPageId;

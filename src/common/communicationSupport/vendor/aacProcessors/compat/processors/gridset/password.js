...
export function resolveGridsetPassword(options, source) {
  var _process$env;
  if (options !== null && options !== void 0 && options.gridsetPassword)
    return options.gridsetPassword;
  const envPassword =
    typeof process !== 'undefined'
      ? (_process$env = process.env) === null || _process$env === void 0
        ? void 0
        : _process$env.GRIDSET_PASSWORD
      : undefined;
...
export function resolveGridsetPasswordFromEnv() {
  ...
  return typeof process !== 'undefined'
    ? (_process$env2 = process.env) === null || _process$env2 === void 0
      ? void 0
      : _process$env2.GRIDSET_PASSWORD
    : undefined;
}

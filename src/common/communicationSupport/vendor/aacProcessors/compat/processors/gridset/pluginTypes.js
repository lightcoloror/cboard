...
export function detectPluginCellType(content) {
  var _content$Style, _content$Style2, _content$Style3;
  if (!content) {
    return {
  ...
  if (
    ...
    ((_content$Style = content.Style) === null || _content$Style === void 0
      ? void 0
      : _content$Style.BasedOnStyle) === 'Workspace'
  ) {
    return {
  ...
  if (
    ...
    ((_content$Style2 = content.Style) === null || _content$Style2 === void 0
      ? void 0
      : _content$Style2.BasedOnStyle) === 'LiveCell'
  ) {
    return {
  ...
  if (
    ...
    ((_content$Style3 = content.Style) === null || _content$Style3 === void 0
      ? void 0
      : _content$Style3.BasedOnStyle) === 'AutoContent'
  ) {
    ...
    return {
      ...
      pluginId: inferAutoContentPlugin(
        autoContentType ? String(autoContentType) : undefined
      ),
...
function extractAutoContentType(content) {
  var _content$Commands, _content$commands;
  const commands =
